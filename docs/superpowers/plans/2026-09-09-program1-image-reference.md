...
- [x] Review contract and current CI; identify image provenance and compatibility risks.
- [x] Add domain validation and nullable migration; update both persistence mappings.
- [x] Preserve legacy fingerprints and test receipt replay across image changes/restart.
- [x] Inspect stored image evidence through existing query boundary or bounded read endpoint.
- [x] Run narrow tests, shared pipeline and CI; update Kanban and verification with remaining gates.
