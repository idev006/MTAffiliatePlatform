...
5. `docs/affiliate-platform/ENGINEERING_GOVERNANCE.md`
6. `docs/affiliate-platform/PROJECT_STRUCTURE_AND_ENGINE_ARCHITECTURE.md`
7. `docs/affiliate-platform/APPLICATION_AND_ENGINE_CONTRACTS.md`
8. `docs/affiliate-platform/DATA_MODEL.md`
9. `docs/affiliate-platform/TEST_STRATEGY_AND_QUALITY_GATES.md`
10. `docs/affiliate-platform/IMPLEMENTATION_READINESS_AND_DEFINITION_OF_READY.md`
11. `docs/affiliate-platform/TECHNOLOGY_STACK.md`
12. `docs/affiliate-platform/specs/README.md`
